...
{{--                            <th scope="col" class="py-3 pl-4 pr-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-300">{{ __('Actions') }}</th>--}}
                        </tr>
                        </thead>
...
{{--                                    <a href="{{ route('users.edit', $user->id) }}" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-100">{{ __('Edit') }}</a>--}}
{{--                                </td>--}}
                            </tr>
                        @endforeach
                        </tbody>
