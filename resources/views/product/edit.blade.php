                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900 dark:text-gray-100">{{ __('Update') }} Product</h1>
                            <p class="mt-2 text-sm text-gray-700 dark:text-gray-300">Update existing {{ __('Product') }}.</p>
                        </div>
